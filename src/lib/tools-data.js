export const categories = [
  { id: 'all', name: 'All Tools', icon: '🧰', count: 86 },
  { id: 'text', name: 'Text Tools', icon: '📝', count: 13 },
  { id: 'image', name: 'Image Tools', icon: '🖼️', count: 9 },
  { id: 'dev', name: 'Developer', icon: '💻', count: 13 },
  { id: 'converter', name: 'Converters', icon: '🔄', count: 10 },
  { id: 'generator', name: 'Generators', icon: '⚡', count: 9 },
  { id: 'calculator', name: 'Calculators', icon: '🧮', count: 11 },
...
export const tools = [
  ...
  { id: 'json-schema', name: 'JSON Schema Generator', desc: 'Generate JSON Schema from sample JSON data', category: 'dev', icon: '📜', color: '#8b5cf6' },
  ...
  { id: 'timezone-converter', name: 'Time Zone Converter', desc: 'Convert time between different global time zones', category: 'converter', icon: '🕒', color: '#8b5cf6' },
  { id: 'data-size-converter', name: 'Data Size Converter', desc: 'Convert between B, KB, MB, GB, TB and PB', category: 'converter', icon: '💾', color: '#3b82f6' },
  ...
  { id: 'user-generator', name: 'Random User Generator', desc: 'Generate random user profiles for testing and development', category: 'generator', icon: '👤', color: '#ec4899' },
  ...
  { id: 'bmr-calculator', name: 'BMR Calculator', desc: 'Calculate your Basal Metabolic Rate to understand your calorie needs', category: 'calculator', icon: '🥗', color: '#10b981' },
  { id: 'compound-interest', name: 'Compound Interest', desc: 'Calculate future investment value with compound interest', category: 'calculator', icon: '📈', color: '#8b5cf6' },
  { id: 'vat-calculator', name: 'VAT / Sales Tax', desc: 'Calculate VAT or Sales Tax on any amount with custom rates', category: 'calculator', icon: '🧾', color: '#3b82f6' },
  { id: 'savings-goal', name: 'Savings Goal', desc: 'Calculate how much to save monthly to reach your financial goal', category: 'calculator', icon: '🎯', color: '#10b981' },
  { id: 'salary-calculator', name: 'Salary Calculator', desc: 'Quickly estimate your annual, monthly, and hourly pay', category: 'calculator', icon: '💵', color: '#f59e0b' },
  ...
  // PRODUCTIVITY
  { id: 'pomodoro-timer', name: 'Pomodoro Timer', desc: 'Stay focused and boost productivity with customizable work/break sessions', category: 'productivity', icon: '🍅', color: '#ef4444' },
  { id: 'list-randomizer', name: 'List Randomizer', desc: 'Shuffle lists or pick a random item for unbiased decision making', category: 'productivity', icon: '🎲', color: '#8b5cf6' },
  { id: 'stopwatch', name: 'Stopwatch', desc: 'Simple and precise stopwatch with lap timing functionality', category: 'productivity', icon: '⏱️', color: '#3b82f6' },
  { id: 'scratchpad', name: 'Quick Scratchpad', desc: 'Simple browser-based notepad that saves your text automatically', category: 'productivity', icon: '📝', color: '#f59e0b' },
  ...
  { id: 'invoice-generator', name: 'Invoice & Receipt Maker', desc: 'Generate professional invoices, business bills, and receipts with PDF export', category: 'productivity', icon: '🧾', color: '#10b981', tag: 'New' },
];
