  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <h1>
          85+ Professional <span className="gradient-text">Online Tools</span><br />
          For Every Task
        </h1>
        <p>
          The most comprehensive collection of 85+ free online tools for developers, designers, and daily tasks.
